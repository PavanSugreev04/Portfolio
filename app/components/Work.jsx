...
const Work = ({isDarkMode}) => {
  ...
  const updatedWorkData = [
  {
    ...
    description: "Machine Learning | NLP | Streamlit",
    bgImage: "/projects/project-1.png",
    link: "https://github.com/PavanSugreev04/Document-Classification.git"
  },
  {
    title: "WhatsApp AI Chatbot",
    description: "AI Chatbot | React | Node.js | Firebase",
    bgImage: "/projects/project-2.png", 
    link: "https://github.com/PavanSugreev04"
  },
  {
    title: "Finance Tracker",
    description: "Full Stack | MERN | JWT Auth",
    bgImage: "/projects/project-3.png",
    link: "https://github.com/PavanSugreev04/Finance_Tracker.git"
  }
];
  ...
  return (
    <motion.div 
      ...
      >
        Welcome to my portfolio. Here are some of the projects that I have worked on.
      </motion.p>
